const Results = () => {
  const testimonials = [
    ...
    },
    {
      ...
      quote: 'Nossa conversão por e-mail subiu de 3% para 11%. A personalização em escala do AtendePlus foi um divisor de águas.',
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-12 sm:mb-16 slide-up px-4">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Veja o que empresas como a sua estão alcançando com o AtendePlus
          </p>
        </div>
